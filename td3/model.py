...
class TD3(object):
    ...
    def train(self, replay_buffer, batch_size=128):
        ...
        target_q1, target_q2 = self.critic_target.call(batch_next_states, next_actions)
    ...
    def load(self, time_path, steps):
        # Save the weights of all the models.
        self.actor.load_weights('./models/{}/actor_{}'.format(time_path, steps))
        self.actor_target.load_weights('./models/{}/actor_target_{}'.format(time_path, steps))

        self.critic.load_weights('./models/{}/critic_{}'.format(time_path, steps))
        self.critic_target.load_weights('./models/{}/critic_target_{}'.format(time_path, steps))